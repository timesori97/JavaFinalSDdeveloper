...
public class DGui extends JFrame implements ActionListener {
      ...
      if (arg0.getSource() == in) {
         if (arg0.getSource() == in) {
            if (idField.getText().isEmpty()) {
               JOptionPane.showMessageDialog(null, "삭제할 아이디를 작성하세요.", "알림", JOptionPane.ERROR_MESSAGE);
               return;
            }
            if (passField.getText().isEmpty()) {

               JOptionPane.showMessageDialog(null, "삭제할 비밀번호를 작성하세요.", "알림", JOptionPane.ERROR_MESSAGE);
               return;
            }
            if (pnumField.getText().isEmpty()) {
               JOptionPane.showMessageDialog(null, "삭제할 전화번호를 작성하세요.", "알림", JOptionPane.ERROR_MESSAGE);
               return;
            }
